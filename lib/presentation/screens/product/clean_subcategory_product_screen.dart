...
class CleanSubcategoryProductScreen extends ConsumerWidget {
  final String subcategoryId;
  final String subcategoryName;
  
  const CleanSubcategoryProductScreen({
    Key? key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // Create params for the subcategory provider
    final params = {
    ...
    final productsState = ref.watch(productsBySubcategoryProvider(params));
    ...
    return Scaffold(
      ...
      body: _buildBody(context, ref, productsState, params),
    );
  }
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ref.read(productsBySubcategoryProvider(params).notifier)
  ...
  void _showFilterDialog(BuildContext context, WidgetRef ref, Map<String, dynamic> currentParams) {
    // Create a copy of current params for modification
    final params = Map<String, dynamic>.from(currentParams);
